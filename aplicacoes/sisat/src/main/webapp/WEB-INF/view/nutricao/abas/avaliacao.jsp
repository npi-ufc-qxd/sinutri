...
<h3>Paciente</h3>
	<div class="form-group">
		...
		<div class="col-sm-3">
			<form:input id="altura" name="altura" type="number" path="paciente.altura" cssClass="form-control" placeholder="Altura" />
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<form:input id="peso" type="number" name="peso" path="peso" cssClass="form-control" placeholder="Peso"/>
			<div class="error-validation">
	...
	<div class="form-group">
		...
		<div class="col-sm-3" >
			<form:input id="cc" type="number" name = "cc" placeholder="Circunferência da cintura" path="circunferenciaCintura" cssClass="form-control" min="0"/>
			<div class="error-validation">
