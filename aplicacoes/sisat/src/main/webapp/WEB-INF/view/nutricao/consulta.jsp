	...
	<div class="container">
		...
		<form:form servletRelativeAction="${url}" method="POST"
			...
			<div class="tab-content">
				...
				<div id="avaliacao" class="tab-pane fade in active"><jsp:include
						page="abas/avaliacao.jsp" /></div>

				<div id="exame" class="tab-pane fade"><jsp:include
						page="abas/exame.jsp" /></div>
