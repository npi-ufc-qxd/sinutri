...
<div class="col-sm-12">
	...
	<input type=text name="medicamentoComentario" size='123' disabled="disabled" id="inputTextMedicamento" value="${ consultaNutricional.medicamentoComentario }"/> <br/><br/>
</div>
...
<div class="col-sm-12">
	...
	<div class="col-sm-12" style="cursor: pointer;">
		...
		<input type=text name="mastigacaoComentario" value="" size='123' disabled="disabled" id="inputTextMastigacao" value="${ consultaNutricional.mastigacaoComentario }"/>
	</div>
</div>
...
<div class="col-sm-12">
	...
	<textarea rows="2" cols="140" name="alergiaComentario" disabled="disabled" id="inputTextAlergia">${ consultaNutricional.alergiaComentario }</textarea>
</div>
