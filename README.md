...
Importante: Copiar o driver do PostgreSQL (postgresql-xxx.jar) e mail.jar (http://mvnrepository.com/artifact/javax.mail/javax.mail-api) para o diretório de libs do Tomcat.
